%latex.default(tableS1, file = "tables/tableS1.tex", title = "",     cgroup = names(studies.vec[-5]), rgroup = c("Wright's method",         "ExLab Normalization", "InLab Normalization"), size = "footnotesize",     label = "tab:confusionABCGCBHEMA", caption = caption)%
\begin{table}[!htbp]
{\footnotesize
...
\hline
{\bfseries ExLab Normalization}&&&&&&&&&&&&&&&\tabularnewline
...
\hline
{\bfseries InLab Normalization}&&&&&&&&&&&&&&&\tabularnewline
