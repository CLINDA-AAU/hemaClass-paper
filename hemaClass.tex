...
This prompted us to create \hemaClass{} which is an online tool providing an easy interface to one-by-one microarray based risk classification of diffuse large B-cell lymphoma (DLBCL).
