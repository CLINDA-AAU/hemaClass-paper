...
\kwd{Cell of origin}
\kwd{Affymetrix Human Genome U133 Plus 2 microarrays}
\end{keyword}
...
\end{enumerate}
All papers documenting the data have stated approval of relevant ethics committes. The GEO datasets were downloaded using the \R{}-package \pkg{DLBCLdata} \cite{DLBCLdata}.
...
The Rituximab resistance classifier \cite{Laursen2014,Laursen2015} is based upon an elastic net approach, like above, however using three classes.
The Melphalan resistance classifier \cite{Boegsted2011} uses sparse partial least squares to assign the classes sensitive, intermediate, and resistant to samples.
...
Supplementary Table S3 and %\ref{tab:confusiondrugonebyone} and
Supplementary Table S4, respectively. %\ref{tab:confusiondrugreference}, respectively.
