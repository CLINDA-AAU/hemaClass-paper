...
\title{hemaClass.org: Online one-by-one normalization and classification of hematological malignacies}
...
\address[id=aff3]{%
  \orgname{Department of Hematopathology, The University of Texas, MD Anderson Cancer Center}
...
The results of the cross validation are shown in Supplementary Figure S1.%\ref{fig:crossval}.
...
\end{equation*}
derived in supplementary section S2.%\ref{sec:graham}.
...
The associated confusion matrices for one-by-one normalisation and reference based normalisation are shown in Supplementary Table S3 %\ref{tab:confusiondrugonebyone}
...
% \end{center}
\caption{\csentence{Comparison of logit probabilities for ABC/GCB and REGS classification obtained through cohort normalisation and \hemaClass{}.}
...
% \end{center}
\caption{\csentence{Comparison of logit probabilities for the BAGS classifier obtained through one-by-one and reference based RMA normalization of \hemaClass{} against cohort RMA normalisation.}
