...
\subsubsection*{Backgroud correction}
...
\end{equation*}
where $\sum_{k=0}^{n_j} \alpha_{jk} = 0$ for all probe-sets. The parameters are estimated by median polish \cite{Holder2001}. The probe affinity estimates are denoted by $\hat{\alpha}_{jk}$.
